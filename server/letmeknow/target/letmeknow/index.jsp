...
<div class="container">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td>NEW!!!</td>
            <td>changeToNotifier?groupId= userId=[]</td>
        </tr>
        <tr>
            <td>DEPRECATED:</td>
...
<div class="container">
    ...
    <tbody>
        <tr>
            <td>searchNotificationBySenderId?senderId=</td>
            <td>searchNotificationByContent?content=</td>
            <td>searchNotificationByGroupId?groupId=</td>
            <td></td>
        </tr>
        <tr>
